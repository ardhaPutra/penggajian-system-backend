...
Route::group(['prefix' => 'uang-saku'], function () {
    ...
    Route::get('/create', [UangSakuController::class, 'create'])->name('uangsaku.create');
...
Route::get('/pilih-negara', function () {return Negara::whereNull('deleted_at')->get();});
Route::get('/pilih-provinsi', function () {return Provinsi::whereNull('deleted_at')->get();});
Route::get('/pilih-kota', function () {return Kota::whereNull('deleted_at')->get();});
...
Route::get('/pilih-pendidikan', function () {return Pendidikan::whereNull('deleted_at')->get();});
Route::get('/pilih-departemen', function () {return Department::whereNull('deleted_at')->get();});
Route::get('/pilih-jabatan', function () {return Jabatan::whereNull('deleted_at')->get();});
Route::get('/pilih-golongan', function () {return Golongan::whereNull('deleted_at')->get();});
...
Route::get('/pilih-karyawan', function () {return Karyawan::all();});
